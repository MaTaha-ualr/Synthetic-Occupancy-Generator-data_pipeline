# Run: `2026-07-23_paper_revision_household_family_birth_calibration_s20260719_seed20260719`
...
| Field | Value |
| --- | --- |
| Scenario | `paper_revision_household_family_birth_calibration_s20260719` |
| Seed | `20260719` |
| Generated (UTC) | 2026-07-24T04:25:39Z |
| Cross-file match mode | `many_to_one` |
| Simulation window | 2026-01-01 → 2027-01-01 |
...
| --- | --- |
| `truth_people` | 6429 |
| `truth_households` | 4575 |
| `truth_household_memberships` | 8509 |
| `truth_residence_history` | 7807 |
| `truth_events` | 1419 |

### Simulated events

`BIRTH`=379, `COHABIT`=1040
...
Cross-file overlap: **6050** shared entities (94.5% of the union).
