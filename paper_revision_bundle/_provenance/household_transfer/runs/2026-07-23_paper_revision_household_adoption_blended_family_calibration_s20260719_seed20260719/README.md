# Run: `2026-07-23_paper_revision_household_adoption_blended_family_calibration_s20260719_seed20260719`
...
| Field | Value |
| --- | --- |
| Scenario | `paper_revision_household_adoption_blended_family_calibration_s20260719` |
| Seed | `20260719` |
| Generated (UTC) | 2026-07-24T04:26:23Z |
| Cross-file match mode | `one_to_one` |
| Simulation window | 2026-01-01 → 2026-02-01 |
...
| --- | --- |
| `truth_people` | 8230 |
| `truth_households` | 3933 |
| `truth_household_memberships` | 10410 |
| `truth_residence_history` | 10410 |
| `truth_events` | 2180 |
...
Cross-file overlap: **8166** shared entities (99.8% of the union).
