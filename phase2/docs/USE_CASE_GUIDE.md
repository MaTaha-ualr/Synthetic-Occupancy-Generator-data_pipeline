...
```bash
python phase2/scripts/run_phase2_pipeline.py --scenario couple_merge
```

Or, if you want the explicit three-step flow:

```bash
python phase2/scripts/generate_phase2_truth.py --run-id 2026-03-11_couple_merge_seed20260311
python phase2/scripts/generate_phase2_observed.py --run-id 2026-03-11_couple_merge_seed20260311
python phase2/scripts/validate_phase2_outputs.py --run-id 2026-03-11_couple_merge_seed20260311
```
