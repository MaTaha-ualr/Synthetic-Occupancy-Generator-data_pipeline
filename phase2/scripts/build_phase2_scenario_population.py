...
def main() -> int:
    ...
    progress = ProgressReporter(
        total=3,
        label="Phase 2 population",
        enabled=not args.no_progress,
    )

    with progress.step("Load scenario and parameters"):
    ...
    with progress.step("Generate scenario population"):
    ...
    with progress.step("Write population outputs"):
