...
See `phase2/scenarios/README.md` for the scenario YAML schema and `phase2/docs/SCENARIO_USE_CASES_AND_TESTING.md` for the benchmark-oriented scenario guide.
